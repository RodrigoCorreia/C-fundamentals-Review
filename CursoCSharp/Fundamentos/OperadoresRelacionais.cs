...
namespace CursoCSharp.Fundamentos
{
    class OperadoresRelacionais
    {
		public static void Executar()
		{
			...
			Console.WriteLine("Tem como melhorar ? {0}", nota2 != 10.0);
			Console.WriteLine("Passou por media? {0}", nota2 >= notaDeCorte);
			Console.WriteLine("Recuperação? {0}", nota2 < notaDeCorte);
